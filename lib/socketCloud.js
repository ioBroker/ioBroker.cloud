    ...
    initCommandsCloud() {
        ...
        this.addCommandHandler('cloudDisconnect', (socket, socketId, err) => {
            ...
            if (socket._subSockets && socketId) {
                ...
                // unsubscribe all sub-sockets, because a client does not use multi-client
            ...
            this.adapter.log.level === 'debug' && this.commands._showSubscribes(socket, 'fileChange');
        ...
        // restore WEB version of written file (without base64)
